const deckCards = src["alakazam.png", 
"Agility.png", 
"Boat.png", 
"Boat.png", 
"Citizenship.png", 
...
//Here get some elements from page and declare some variable that are need for this Game like:

// deck : Access the with class of .deck
// opened : Create an empty array to store the opened cards
// matched : Create an empty array to store the matched cards
// modal : Access the modal
// reset : Access the reset button
// playAgain : Access the play again button
// movesCount : Select the class moves-counter and change it’s HTML
// moves : moves counter, start the count at zero
// star : star rating section
// starCount : Variable to keep track of how many stars are left
// timeCounter : for the t imer
// time : stop the time
// minutes,seconds : variables for time count, start all at zero
// timeStart : click card event listener
